...
int main(void)
{
    profiler::SetTitle("Performance: libmpi vs OpenSSL/BN");
    profiler::SetFormats(profiler::FORMAT_RAW | profiler::FORMAT_REMARK | profiler::FORMAT_TABLE_XTERM
                         | profiler::FORMAT_TABLE_MARKDOWN);
    ...
    // and convert mpi to hex string
    {
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::from-string", [&]() -> bool {
                BN_hex2bn(&r, val.c_str());
                return true;
            });
            profiler::AsReference("openssl::from-string");

            profiler::Add("openssl::to-string", [&]() -> bool {
                free(BN_bn2hex(r));
                return true;
            });
            profiler::AsReference("openssl::to-string");
        ...
        // this implementation
        {
            ...
            profiler::Add("mpi::from-string", [&]() -> bool {
                return mpi_from_string(&r, val.c_str()) == 0;
            });

            profiler::Add("mpi::to-string", [&]() -> bool {
    ...
    // and convert mpi to octets string
    {
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::from-octets", [&]() -> bool {
                BN_bin2bn(buffer.data(), static_cast<int>(buffer.size()), r);
                return true;
            });
            profiler::AsReference("openssl::from-octets");

            profiler::Add("openssl::to-octets", [&]() -> bool {
                BN_bn2bin(r, buffer.data());
                return true;
            });
            profiler::AsReference("openssl::to-octets");
        ...
        // this implementation
        {
            ...
            profiler::Add("mpi::from-octets", [&]() -> bool {
                return mpi_from_octets(&r, buffer.data(), buffer.size()) == 0;
            });

            profiler::Add("mpi::to-octets", [&]() -> bool {
    ...
    // addition, addition-and-assign
    {
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::add", [&]() -> bool {
                BN_add(r, a, b);
                return true;
            });
            profiler::AsReference("openssl::add");
...

    {
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::add-assign", [&]() -> bool {
                BN_add(r, r, b);
                return true;
            });
            profiler::AsReference("openssl::add-assign");
        ...
        // this implementation
        {
            ...
            profiler::Add("mpi::add-assign", [&]() -> bool {
    ...
    // subtraction, subtraction-and-assign
    {
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::sub", [&]() -> bool {
                BN_sub(r, a, b);
                return true;
            });
            profiler::AsReference("openssl::sub");
...

    {
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::sub-assign", [&]() -> bool {
                BN_sub(r, r, b);
                return true;
            });
            profiler::AsReference("openssl::sub-assign");
        ...
        // this implementation
        {
            ...
            profiler::Add("mpi::sub-assign", [&]() -> bool {
    ...
    // multiplication, square
    {
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::mul", [&]() -> bool {
                BN_mul(r, a, b, ctx);
                return true;
            });
            profiler::AsReference("openssl::mul");
...

    {
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::sqr", [&]() -> bool {
                BN_sqr(r, a, ctx);
                return true;
            });
            profiler::AsReference("openssl::sqr");
    ...
    // division, modular
    {
        std::vector<unsigned char> abuffer, bbuffer;
        {
            ...
            if (abuffer.size() < bbuffer.size()) {
                abuffer.swap(bbuffer);
            }
        }
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::div", [&]() -> bool {
                BN_div(q, r, a, b, ctx);
                return true;
            });
            profiler::AsReference("openssl::div");
    ...
    //   times faster
    {
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::gcd_consttime", [&]() -> bool {
                BN_gcd(r, a, b, ctx);
                return true;
            });
            profiler::AsReference("openssl::gcd_consttime");
        ...
        // this implementation
        {
            ...
            profiler::Add("mpi::gcd_consttime", [&]() -> bool {
                return mpi_gcd_consttime(r, a, b, NULL) == 0;
            });

#if 0
            // FIXME: Lehmer's gcd algorithm
            profiler::Add("mpi::gcd", [&]() -> bool {
    ...
    // montgomery exponentiation
    {
        ...
        // openssl
        {
            ...
            profiler::Add("openssl::montgomery-exp", [&]() -> bool {
                return BN_mod_exp_mont(r, g, e, n, ctx, mont) == 1;
            });
            profiler::AsReference("openssl::montgomery-exp");

            profiler::Add("openssl::montgomery-exp-consttime", [&]() -> bool {
                return BN_mod_exp_mont_consttime(r, g, e, n, ctx, mont) == 1;
            });
            profiler::AsReference("openssl::montgomery-exp-consttime");
        ...
        // this implementation
        {
            ...
            profiler::Add("mpi::montgomery-exp", [&]() -> bool {
                return mpi_montgomery_exp(r, g, e, mont) == 0;
            });

            profiler::Add("mpi::montgomery-exp-consttime", [&]() -> bool {
    ...
    // prime generation
    {
        ...
        // generate prime: openssl
        {
            ...
            profiler::Add("openssl::generate_prime", [&]() -> bool {
                return BN_generate_prime_ex(prime, bits, 0, NULL, NULL, NULL) == 1;
            });
            profiler::AsReference("openssl::generate_prime");

            BN_free(prime);
        }

        // FIXME: generate prime
        if (0) {
            mpi_t *prime = mpi_create(bits);

            profiler::Add("mpi::generate_prime", [&]() -> bool {
    ...
    // prime verification
    {
        ...
        // generate prime using openssl
        {
            ...
            profiler::Add("openssl::is_prime", [&]() -> bool {
                return BN_is_prime_fasttest_ex(r, BN_prime_checks, NULL, 0, NULL) == 1;
            });
            profiler::AsReference("openssl::is_prime");
        ...
        if (0) { // FIXME
            ...
            profiler::Add("mpi::is_prime", [&]() -> bool {
                return mpi_is_prime(
                           r, 0, 0, NULL,
                           [](void *state, unsigned char *buffer, unsigned int size) -> int {
                               (void)state;
    ...
    //   2. a * 32 = a << 5, from this case, mpi_lshift is the better choise.
    {
        ...
        profiler::Add("MUL2(a * 2 = a + a)", [&]() -> bool {
            return mpi_add(r, a, a) == 0;
        });

        profiler::Add("MUL2(a * 2 = a << 1)", [&]() -> bool {
