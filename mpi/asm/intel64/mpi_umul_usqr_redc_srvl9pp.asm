...
%include "bn_umulpp.inc"
%include "bn_usqrpp.inc"
%include "mred_pp.inc"

;*************************************************************
;* uint64_t  mpi_umul_bin_adx(uint64_t* pR;
...
.quit:
   ...
   REST_GPR
   ret
ENDFUNC mpi_umul_bin_adx

;*************************************************************
;*
;* uint64_t  mpi_usqr_bin_adx(uint64_t* pR;
;*                       const uint64_t* pA, int  aSize)
;*
;*************************************************************
align ARCH_ALIGN_FACTOR
IPPASM mpi_usqr_bin_adx,PUBLIC
%assign LOCAL_FRAME 0
        USES_GPR rbx,rbp,rsi,rdi,r12,r13,r14,r15
        USES_XMM
        COMP_ABI 3
...
.quit:
   ...
   REST_GPR
   ret
ENDFUNC mpi_usqr_bin_adx

;*************************************************************
;*
;* uint64_t  mpi_montgomery_reduce_bin_adx(uint64_t* pR;
;*                          uint64_t* pProduct,
;*                    const uint64_t* pModulus, int  mSize,
;*                          uint64_t  m)
;*************************************************************
align ARCH_ALIGN_FACTOR
IPPASM mpi_montgomery_reduce_bin_adx,PUBLIC
%assign LOCAL_FRAME (0)
        USES_GPR rbx,rbp,rsi,rdi,r12,r13,r14,r15
        USES_XMM
        COMP_ABI 5
...
.quit:
   ...
   REST_GPR
   ret
ENDFUNC mpi_montgomery_reduce_bin_adx
