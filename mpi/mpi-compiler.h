...
#define COMPILER_GNUC_VERSION_CHECK(major, minor, patch) (COMPILER_GNUC_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_MSVC_VERSION COMPILER_VERSION_ENCODE(_MSC_FULL_VER / 10000000, (_MSC_FULL_VER % 10000000) / 100000, (_MSC_FULL_VER % 100000) / 100)
#elif defined(_MSC_FULL_VER) && !defined(__ICL)
#define COMPILER_MSVC_VERSION COMPILER_VERSION_ENCODE(_MSC_FULL_VER / 1000000, (_MSC_FULL_VER % 1000000) / 10000, (_MSC_FULL_VER % 10000) / 10)
...
#define COMPILER_MSVC_VERSION_CHECK(major, minor, patch) (_MSC_FULL_VER >= ((major * 10000000) + (minor * 100000) + (patch)))
#elif defined(_MSC_VER) && (_MSC_VER >= 1200)
#define COMPILER_MSVC_VERSION_CHECK(major, minor, patch) (_MSC_FULL_VER >= ((major * 1000000) + (minor * 10000) + (patch)))
#else
...
#define COMPILER_INTEL_VERSION COMPILER_VERSION_ENCODE(__INTEL_COMPILER / 100, __INTEL_COMPILER % 100, __INTEL_COMPILER_UPDATE)
...
#define COMPILER_INTEL_VERSION_CHECK(major, minor, patch) (COMPILER_INTEL_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_INTEL_CL_VERSION_CHECK(major, minor, patch) (COMPILER_INTEL_CL_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_PGI_VERSION_CHECK(major, minor, patch) (COMPILER_PGI_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_SUNPRO_VERSION COMPILER_VERSION_ENCODE((((__SUNPRO_C >> 16) & 0xf) * 10) + ((__SUNPRO_C >> 12) & 0xf), (((__SUNPRO_C >> 8) & 0xf) * 10) + ((__SUNPRO_C >> 4) & 0xf), (__SUNPRO_C & 0xf) * 10)
#elif defined(__SUNPRO_C)
#define COMPILER_SUNPRO_VERSION COMPILER_VERSION_ENCODE((__SUNPRO_C >> 8) & 0xf, (__SUNPRO_C >> 4) & 0xf, (__SUNPRO_C)&0xf)
#elif defined(__SUNPRO_CC) && (__SUNPRO_CC > 0x1000)
#define COMPILER_SUNPRO_VERSION COMPILER_VERSION_ENCODE((((__SUNPRO_CC >> 16) & 0xf) * 10) + ((__SUNPRO_CC >> 12) & 0xf), (((__SUNPRO_CC >> 8) & 0xf) * 10) + ((__SUNPRO_CC >> 4) & 0xf), (__SUNPRO_CC & 0xf) * 10)
#elif defined(__SUNPRO_CC)
#define COMPILER_SUNPRO_VERSION COMPILER_VERSION_ENCODE((__SUNPRO_CC >> 8) & 0xf, (__SUNPRO_CC >> 4) & 0xf, (__SUNPRO_CC)&0xf)
#endif
...
#define COMPILER_SUNPRO_VERSION_CHECK(major, minor, patch) (COMPILER_SUNPRO_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_EMSCRIPTEN_VERSION COMPILER_VERSION_ENCODE(__EMSCRIPTEN_major__, __EMSCRIPTEN_minor__, __EMSCRIPTEN_tiny__)
#endif
...
#define COMPILER_EMSCRIPTEN_VERSION_CHECK(major, minor, patch) (COMPILER_EMSCRIPTEN_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_ARM_VERSION COMPILER_VERSION_ENCODE(__ARMCOMPILER_VERSION / 1000000, (__ARMCOMPILER_VERSION % 1000000) / 10000, (__ARMCOMPILER_VERSION % 10000) / 100)
#elif defined(__CC_ARM) && defined(__ARMCC_VERSION)
#define COMPILER_ARM_VERSION COMPILER_VERSION_ENCODE(__ARMCC_VERSION / 1000000, (__ARMCC_VERSION % 1000000) / 10000, (__ARMCC_VERSION % 10000) / 100)
#endif
...
#define COMPILER_ARM_VERSION_CHECK(major, minor, patch) (COMPILER_ARM_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_IBM_VERSION COMPILER_VERSION_ENCODE(__ibmxl_version__, __ibmxl_release__, __ibmxl_modification__)
#elif defined(__xlC__) && defined(__xlC_ver__)
#define COMPILER_IBM_VERSION COMPILER_VERSION_ENCODE(__xlC__ >> 8, __xlC__ & 0xff, (__xlC_ver__ >> 8) & 0xff)
...
#define COMPILER_IBM_VERSION_CHECK(major, minor, patch) (COMPILER_IBM_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_TI_VERSION COMPILER_VERSION_ENCODE(__TI_COMPILER_VERSION__ / 1000000, (__TI_COMPILER_VERSION__ % 1000000) / 1000, (__TI_COMPILER_VERSION__ % 1000))
#endif
#endif
...
#define COMPILER_TI_VERSION_CHECK(major, minor, patch) (COMPILER_TI_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_TI_CL2000_VERSION COMPILER_VERSION_ENCODE(__TI_COMPILER_VERSION__ / 1000000, (__TI_COMPILER_VERSION__ % 1000000) / 1000, (__TI_COMPILER_VERSION__ % 1000))
#endif
...
#define COMPILER_TI_CL2000_VERSION_CHECK(major, minor, patch) (COMPILER_TI_CL2000_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_TI_CL430_VERSION COMPILER_VERSION_ENCODE(__TI_COMPILER_VERSION__ / 1000000, (__TI_COMPILER_VERSION__ % 1000000) / 1000, (__TI_COMPILER_VERSION__ % 1000))
#endif
...
#define COMPILER_TI_CL430_VERSION_CHECK(major, minor, patch) (COMPILER_TI_CL430_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_TI_ARMCL_VERSION COMPILER_VERSION_ENCODE(__TI_COMPILER_VERSION__ / 1000000, (__TI_COMPILER_VERSION__ % 1000000) / 1000, (__TI_COMPILER_VERSION__ % 1000))
#endif
...
#define COMPILER_TI_ARMCL_VERSION_CHECK(major, minor, patch) (COMPILER_TI_ARMCL_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_TI_CL6X_VERSION COMPILER_VERSION_ENCODE(__TI_COMPILER_VERSION__ / 1000000, (__TI_COMPILER_VERSION__ % 1000000) / 1000, (__TI_COMPILER_VERSION__ % 1000))
#endif
...
#define COMPILER_TI_CL6X_VERSION_CHECK(major, minor, patch) (COMPILER_TI_CL6X_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_TI_CL7X_VERSION COMPILER_VERSION_ENCODE(__TI_COMPILER_VERSION__ / 1000000, (__TI_COMPILER_VERSION__ % 1000000) / 1000, (__TI_COMPILER_VERSION__ % 1000))
#endif
...
#define COMPILER_TI_CL7X_VERSION_CHECK(major, minor, patch) (COMPILER_TI_CL7X_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_TI_CLPRU_VERSION COMPILER_VERSION_ENCODE(__TI_COMPILER_VERSION__ / 1000000, (__TI_COMPILER_VERSION__ % 1000000) / 1000, (__TI_COMPILER_VERSION__ % 1000))
#endif
...
#define COMPILER_TI_CLPRU_VERSION_CHECK(major, minor, patch) (COMPILER_TI_CLPRU_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_CRAY_VERSION_CHECK(major, minor, patch) (COMPILER_CRAY_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#if __VER__ > 1000
#define COMPILER_IAR_VERSION COMPILER_VERSION_ENCODE((__VER__ / 1000000), ((__VER__ / 1000) % 1000), (__VER__ % 1000))
#else
...
#define COMPILER_IAR_VERSION_CHECK(major, minor, patch) (COMPILER_IAR_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_TINYC_VERSION COMPILER_VERSION_ENCODE(__TINYC__ / 1000, (__TINYC__ / 100) % 10, __TINYC__ % 100)
#endif
...
#define COMPILER_TINYC_VERSION_CHECK(major, minor, patch) (COMPILER_TINYC_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_DMC_VERSION_CHECK(major, minor, patch) (COMPILER_DMC_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_COMPCERT_VERSION COMPILER_VERSION_ENCODE(__COMPCERT_VERSION__ / 10000, (__COMPCERT_VERSION__ / 100) % 100, __COMPCERT_VERSION__ % 100)
#endif
...
#define COMPILER_COMPCERT_VERSION_CHECK(major, minor, patch) (COMPILER_COMPCERT_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_PELLES_VERSION_CHECK(major, minor, patch) (COMPILER_PELLES_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#define COMPILER_MCST_LCC_VERSION_CHECK(major, minor, patch) (COMPILER_MCST_LCC_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#endif
#if defined(COMPILER_GNUC_VERSION) && !defined(__clang__) && !defined(COMPILER_INTEL_VERSION) && !defined(COMPILER_PGI_VERSION) && !defined(COMPILER_ARM_VERSION) && !defined(COMPILER_CRAY_VERSION) && !defined(COMPILER_TI_VERSION)        \
    && !defined(COMPILER_TI_ARMCL_VERSION) && !defined(COMPILER_TI_CL430_VERSION) && !defined(COMPILER_TI_CL2000_VERSION) && !defined(COMPILER_TI_CL6X_VERSION) && !defined(COMPILER_TI_CL7X_VERSION) && !defined(COMPILER_TI_CLPRU_VERSION) \
    && !defined(__COMPCERT__) && !defined(COMPILER_MCST_LCC_VERSION)
...
#define COMPILER_GCC_VERSION_CHECK(major, minor, patch) (COMPILER_GCC_VERSION >= COMPILER_VERSION_ENCODE(major, minor, patch))
#else
...
#else
#define COMPILER_GNUC_HAS_ATTRIBUTE(attribute, major, minor, patch) COMPILER_GNUC_VERSION_CHECK(major, minor, patch)
#endif
...
#else
#define COMPILER_GCC_HAS_ATTRIBUTE(attribute, major, minor, patch) COMPILER_GCC_VERSION_CHECK(major, minor, patch)
#endif

#ifdef COMPILER_HAS_CPP_ATTRIBUTE
#undef COMPILER_HAS_CPP_ATTRIBUTE
#endif
#if defined(__has_cpp_attribute) && defined(__cplusplus) && (!defined(COMPILER_SUNPRO_VERSION) || COMPILER_SUNPRO_VERSION_CHECK(5, 15, 0))
...
#elif !defined(COMPILER_PGI_VERSION) && !defined(COMPILER_IAR_VERSION) && (!defined(COMPILER_SUNPRO_VERSION) || COMPILER_SUNPRO_VERSION_CHECK(5, 15, 0)) && (!defined(COMPILER_MSVC_VERSION) || COMPILER_MSVC_VERSION_CHECK(19, 20, 0))
...
#else
#define COMPILER_GNUC_HAS_CPP_ATTRIBUTE(attribute, major, minor, patch) COMPILER_GNUC_VERSION_CHECK(major, minor, patch)
#endif
...
#else
#define COMPILER_GCC_HAS_CPP_ATTRIBUTE(attribute, major, minor, patch) COMPILER_GCC_VERSION_CHECK(major, minor, patch)
#endif
...
#else
#define COMPILER_GNUC_HAS_BUILTIN(builtin, major, minor, patch) COMPILER_GNUC_VERSION_CHECK(major, minor, patch)
#endif
...
#else
#define COMPILER_GCC_HAS_BUILTIN(builtin, major, minor, patch) COMPILER_GCC_VERSION_CHECK(major, minor, patch)
#endif
...
#else
#define COMPILER_GNUC_HAS_FEATURE(feature, major, minor, patch) COMPILER_GNUC_VERSION_CHECK(major, minor, patch)
#endif
...
#else
#define COMPILER_GCC_HAS_FEATURE(feature, major, minor, patch) COMPILER_GCC_VERSION_CHECK(major, minor, patch)
#endif
...
#else
#define COMPILER_GNUC_HAS_EXTENSION(extension, major, minor, patch) COMPILER_GNUC_VERSION_CHECK(major, minor, patch)
#endif
...
#else
#define COMPILER_GCC_HAS_EXTENSION(extension, major, minor, patch) COMPILER_GCC_VERSION_CHECK(major, minor, patch)
#endif
...
#endif
#if defined(__has_declspec_attribute)
#define COMPILER_GNUC_HAS_DECLSPEC_ATTRIBUTE(attribute, major, minor, patch) __has_declspec_attribute(attribute)
#else
#define COMPILER_GNUC_HAS_DECLSPEC_ATTRIBUTE(attribute, major, minor, patch) COMPILER_GNUC_VERSION_CHECK(major, minor, patch)
#endif
...
#endif
#if defined(__has_declspec_attribute)
#define COMPILER_GCC_HAS_DECLSPEC_ATTRIBUTE(attribute, major, minor, patch) __has_declspec_attribute(attribute)
#else
#define COMPILER_GCC_HAS_DECLSPEC_ATTRIBUTE(attribute, major, minor, patch) COMPILER_GCC_VERSION_CHECK(major, minor, patch)
#endif
...
#else
#define COMPILER_GNUC_HAS_WARNING(warning, major, minor, patch) COMPILER_GNUC_VERSION_CHECK(major, minor, patch)
#endif
...
#else
#define COMPILER_GCC_HAS_WARNING(warning, major, minor, patch) COMPILER_GCC_VERSION_CHECK(major, minor, patch)
#endif
...
#endif
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__clang__) || COMPILER_GCC_VERSION_CHECK(3, 0, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_IAR_VERSION_CHECK(8, 0, 0)             \
    || COMPILER_PGI_VERSION_CHECK(18, 4, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0) || COMPILER_TI_VERSION_CHECK(15, 12, 0) || COMPILER_TI_ARMCL_VERSION_CHECK(4, 7, 0) || COMPILER_TI_CL430_VERSION_CHECK(2, 0, 1)         \
    || COMPILER_TI_CL2000_VERSION_CHECK(6, 1, 0) || COMPILER_TI_CL6X_VERSION_CHECK(7, 0, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0) || COMPILER_CRAY_VERSION_CHECK(5, 0, 0) \
    || COMPILER_TINYC_VERSION_CHECK(0, 9, 17) || COMPILER_SUNPRO_VERSION_CHECK(8, 0, 0) || (COMPILER_IBM_VERSION_CHECK(10, 1, 0) && defined(__C99_PRAGMA_OPERATOR))
...
#elif COMPILER_TI_VERSION_CHECK(15, 12, 0) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0) || COMPILER_TI_CL430_VERSION_CHECK(4, 4, 0) || COMPILER_TI_CL6X_VERSION_CHECK(8, 1, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) \
...
#define COMPILER_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_(xpr) \
    ...
    _Pragma("clang diagnostic ignored \"-Wc++98-compat\"") _Pragma("clang diagnostic ignored \"-Wc++17-extensions\"") _Pragma("clang diagnostic ignored \"-Wc++1z-extensions\"") xpr COMPILER_DIAGNOSTIC_POP
#else
#define COMPILER_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_(xpr) \
    COMPILER_DIAGNOSTIC_PUSH                                \
    _Pragma("clang diagnostic ignored \"-Wc++98-compat\"") _Pragma("clang diagnostic ignored \"-Wc++17-extensions\"") xpr COMPILER_DIAGNOSTIC_POP
#endif
#else
#define COMPILER_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_(xpr) \
    COMPILER_DIAGNOSTIC_PUSH                                \
...
#elif COMPILER_HAS_WARNING("-Wcast-qual") || COMPILER_GCC_VERSION_CHECK(4, 6, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0)
...
#define COMPILER_DIAGNOSTIC_DISABLE_DEPRECATED _Pragma("clang diagnostic ignored \"-Wdeprecated-declarations\"")
#elif COMPILER_INTEL_VERSION_CHECK(13, 0, 0)
...
#define COMPILER_DIAGNOSTIC_DISABLE_DEPRECATED _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"")
#elif COMPILER_MSVC_VERSION_CHECK(15, 0, 0)
#define COMPILER_DIAGNOSTIC_DISABLE_DEPRECATED __pragma(warning(disable : 4996))
#elif COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
#define COMPILER_DIAGNOSTIC_DISABLE_DEPRECATED _Pragma("diag_suppress 1215,1444")
#elif COMPILER_TI_VERSION_CHECK(15, 12, 0) || (COMPILER_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0)                                                   \
    || (COMPILER_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || (COMPILER_TI_CL430_VERSION_CHECK(4, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) \
    || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0) || (COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0)     \
    || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0)
...
#define COMPILER_DIAGNOSTIC_DISABLE_DEPRECATED _Pragma("error_messages(off,E_DEPRECATED_ATT,E_DEPRECATED_ATT_MESS)")
#elif COMPILER_SUNPRO_VERSION_CHECK(5, 13, 0) && defined(__cplusplus)
...
#define COMPILER_DIAGNOSTIC_DISABLE_UNKNOWN_PRAGMAS _Pragma("clang diagnostic ignored \"-Wunknown-pragmas\"")
#elif COMPILER_INTEL_VERSION_CHECK(13, 0, 0)
...
#elif COMPILER_TI_VERSION_CHECK(16, 9, 0) || COMPILER_TI_CL6X_VERSION_CHECK(8, 0, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) || COMPILER_TI_CLPRU_VERSION_CHECK(2, 3, 0)
...
#define COMPILER_DIAGNOSTIC_DISABLE_UNKNOWN_CPP_ATTRIBUTES _Pragma("clang diagnostic ignored \"-Wunknown-attributes\"")
#elif COMPILER_GCC_VERSION_CHECK(4, 6, 0)
#define COMPILER_DIAGNOSTIC_DISABLE_UNKNOWN_CPP_ATTRIBUTES _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"")
...
#elif COMPILER_TI_VERSION_CHECK(18, 1, 0) || COMPILER_TI_CL6X_VERSION_CHECK(8, 3, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0)
...
#define COMPILER_DIAGNOSTIC_DISABLE_UNUSED_FUNCTION _Pragma("clang diagnostic ignored \"-Wunused-function\"")
...
#define COMPILER_DEPRECATED_FOR(since, replacement) __declspec(deprecated("Since " #since "; use " #replacement))
#elif (COMPILER_HAS_EXTENSION(attribute_deprecated_with_message) && !defined(COMPILER_IAR_VERSION)) || COMPILER_GCC_VERSION_CHECK(4, 5, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_ARM_VERSION_CHECK(5, 6, 0) \
    || COMPILER_SUNPRO_VERSION_CHECK(5, 13, 0) || COMPILER_PGI_VERSION_CHECK(17, 10, 0) || COMPILER_TI_VERSION_CHECK(18, 1, 0) || COMPILER_TI_ARMCL_VERSION_CHECK(18, 1, 0) || COMPILER_TI_CL6X_VERSION_CHECK(8, 3, 0)      \
    || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) || COMPILER_TI_CLPRU_VERSION_CHECK(2, 3, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
#define COMPILER_DEPRECATED(since)                  __attribute__((__deprecated__("Since " #since)))
#define COMPILER_DEPRECATED_FOR(since, replacement) __attribute__((__deprecated__("Since " #since "; use " #replacement)))
#elif defined(__cplusplus) && (__cplusplus >= 201402L)
#define COMPILER_DEPRECATED(since)                  COMPILER_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_([[deprecated("Since " #since)]])
#define COMPILER_DEPRECATED_FOR(since, replacement) COMPILER_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_([[deprecated("Since " #since "; use " #replacement)]])
#elif COMPILER_HAS_ATTRIBUTE(deprecated) || COMPILER_GCC_VERSION_CHECK(3, 1, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0) || COMPILER_TI_VERSION_CHECK(15, 12, 0)                                                                 \
    || (COMPILER_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0) || (COMPILER_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) \
    || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || (COMPILER_TI_CL430_VERSION_CHECK(4, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0)                                            \
    || (COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0)    \
    || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10) || COMPILER_IAR_VERSION_CHECK(8, 10, 0)
...
#elif COMPILER_MSVC_VERSION_CHECK(13, 10, 0) || COMPILER_PELLES_VERSION_CHECK(6, 50, 0) || COMPILER_INTEL_CL_VERSION_CHECK(2021, 1, 0)
...
#endif
#if COMPILER_HAS_ATTRIBUTE(warning) || COMPILER_GCC_VERSION_CHECK(4, 3, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
#define COMPILER_UNAVAILABLE(available_since) __attribute__((__warning__("Not available until " #available_since)))
#else
...
#endif
#if COMPILER_HAS_ATTRIBUTE(warn_unused_result) || COMPILER_GCC_VERSION_CHECK(3, 4, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_TI_VERSION_CHECK(15, 12, 0)                                                        \
    || (COMPILER_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0) || (COMPILER_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) \
    || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || (COMPILER_TI_CL430_VERSION_CHECK(4, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0)                                            \
    || (COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0)    \
    || (COMPILER_SUNPRO_VERSION_CHECK(5, 15, 0) && defined(__cplusplus)) || COMPILER_PGI_VERSION_CHECK(17, 10, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#define COMPILER_WARN_UNUSED_RESULT_MSG(msg) COMPILER_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_([[nodiscard(msg)]])
...
#endif
#if COMPILER_HAS_ATTRIBUTE(sentinel) || COMPILER_GCC_VERSION_CHECK(4, 0, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_ARM_VERSION_CHECK(5, 4, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#elif COMPILER_HAS_ATTRIBUTE(noreturn) || COMPILER_GCC_VERSION_CHECK(3, 2, 0) || COMPILER_SUNPRO_VERSION_CHECK(5, 11, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0) || COMPILER_IBM_VERSION_CHECK(10, 1, 0)                         \
    || COMPILER_TI_VERSION_CHECK(15, 12, 0) || (COMPILER_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0)                                                  \
    || (COMPILER_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || (COMPILER_TI_CL430_VERSION_CHECK(4, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) \
    || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0) || (COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0)     \
...
#endif
#if COMPILER_MSVC_VERSION_CHECK(13, 10, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_INTEL_CL_VERSION_CHECK(2021, 1, 0)
...
#endif
#if (COMPILER_HAS_BUILTIN(__builtin_unreachable) && (!defined(COMPILER_ARM_VERSION))) || COMPILER_GCC_VERSION_CHECK(4, 5, 0) || COMPILER_PGI_VERSION_CHECK(18, 10, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) \
    || COMPILER_IBM_VERSION_CHECK(13, 1, 5) || COMPILER_CRAY_VERSION_CHECK(10, 0, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#endif
#endif
#if COMPILER_HAS_ATTRIBUTE(nonnull) || COMPILER_GCC_VERSION_CHECK(3, 3, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0)
...
#define COMPILER_PRINTF_FORMAT(string_idx, first_to_check) __attribute__((__format__(ms_printf, string_idx, first_to_check)))
#elif defined(__MINGW32__) && COMPILER_GCC_HAS_ATTRIBUTE(format, 4, 4, 0) && defined(__USE_MINGW_ANSI_STDIO)
#define COMPILER_PRINTF_FORMAT(string_idx, first_to_check) __attribute__((__format__(gnu_printf, string_idx, first_to_check)))
#elif COMPILER_HAS_ATTRIBUTE(format) || COMPILER_GCC_VERSION_CHECK(3, 1, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_ARM_VERSION_CHECK(5, 6, 0) || COMPILER_IBM_VERSION_CHECK(10, 1, 0) || COMPILER_TI_VERSION_CHECK(15, 12, 0) \
    || (COMPILER_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0) || (COMPILER_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__))               \
    || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || (COMPILER_TI_CL430_VERSION_CHECK(4, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0)                                                          \
    || (COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0)                  \
    || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
#define COMPILER_PRINTF_FORMAT(string_idx, first_to_check) __attribute__((__format__(__printf__, string_idx, first_to_check)))
#elif COMPILER_PELLES_VERSION_CHECK(6, 0, 0)
#define COMPILER_PRINTF_FORMAT(string_idx, first_to_check) __declspec(vaformat(printf, string_idx, first_to_check))
#else
...
#endif
#if (COMPILER_HAS_BUILTIN(__builtin_expect_with_probability) && !defined(COMPILER_PGI_VERSION)) || COMPILER_GCC_VERSION_CHECK(9, 0, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
#define COMPILER_PREDICT(expr, value, probability) __builtin_expect_with_probability((expr), (value), (probability))
#define COMPILER_PREDICT_TRUE(expr, probability)   __builtin_expect_with_probability(!!(expr), 1, (probability))
#define COMPILER_PREDICT_FALSE(expr, probability)  __builtin_expect_with_probability(!!(expr), 0, (probability))
#define COMPILER_LIKELY(expr)                      __builtin_expect(!!(expr), 1)
#define COMPILER_UNLIKELY(expr)                    __builtin_expect(!!(expr), 0)
#elif (COMPILER_HAS_BUILTIN(__builtin_expect) && !defined(COMPILER_INTEL_CL_VERSION)) || COMPILER_GCC_VERSION_CHECK(3, 0, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || (COMPILER_SUNPRO_VERSION_CHECK(5, 15, 0) && defined(__cplusplus)) \
    || COMPILER_ARM_VERSION_CHECK(4, 1, 0) || COMPILER_IBM_VERSION_CHECK(10, 1, 0) || COMPILER_TI_VERSION_CHECK(15, 12, 0) || COMPILER_TI_ARMCL_VERSION_CHECK(4, 7, 0) || COMPILER_TI_CL430_VERSION_CHECK(3, 1, 0)                          \
    || COMPILER_TI_CL2000_VERSION_CHECK(6, 1, 0) || COMPILER_TI_CL6X_VERSION_CHECK(6, 1, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0) || COMPILER_TINYC_VERSION_CHECK(0, 9, 27)                \
    || COMPILER_CRAY_VERSION_CHECK(8, 1, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
#define COMPILER_PREDICT(expr, expected, probability) (((probability) >= 0.9) ? __builtin_expect((expr), (expected)) : (COMPILER_STATIC_CAST(void, expected), (expr)))
...
#endif
#if COMPILER_HAS_ATTRIBUTE(malloc) || COMPILER_GCC_VERSION_CHECK(3, 1, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_SUNPRO_VERSION_CHECK(5, 11, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0) || COMPILER_IBM_VERSION_CHECK(12, 1, 0) \
    || COMPILER_TI_VERSION_CHECK(15, 12, 0) || (COMPILER_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0)                                                                \
    || (COMPILER_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || (COMPILER_TI_CL430_VERSION_CHECK(4, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__))               \
    || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0) || (COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0)                   \
...
#undef COMPILER_PURE
#endif
#if COMPILER_HAS_ATTRIBUTE(pure) || COMPILER_GCC_VERSION_CHECK(2, 96, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_SUNPRO_VERSION_CHECK(5, 11, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0) || COMPILER_IBM_VERSION_CHECK(10, 1, 0) \
    || COMPILER_TI_VERSION_CHECK(15, 12, 0) || (COMPILER_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0)                                                               \
    || (COMPILER_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || (COMPILER_TI_CL430_VERSION_CHECK(4, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__))              \
    || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0) || (COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0)                  \
    || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0) || COMPILER_PGI_VERSION_CHECK(17, 10, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
#define COMPILER_PURE __attribute__((__pure__))
#elif COMPILER_SUNPRO_VERSION_CHECK(5, 10, 0)
#define COMPILER_PURE _Pragma("does_not_write_global_data")
#elif defined(__cplusplus) && (COMPILER_TI_CL430_VERSION_CHECK(2, 0, 1) || COMPILER_TI_CL6X_VERSION_CHECK(4, 0, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0))
...
#endif
#if COMPILER_HAS_ATTRIBUTE(const) || COMPILER_GCC_VERSION_CHECK(2, 5, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_SUNPRO_VERSION_CHECK(5, 11, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0) || COMPILER_IBM_VERSION_CHECK(10, 1, 0) \
    || COMPILER_TI_VERSION_CHECK(15, 12, 0) || (COMPILER_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0)                                                               \
    || (COMPILER_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || (COMPILER_TI_CL430_VERSION_CHECK(4, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__))              \
    || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0) || (COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0)                  \
    || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0) || COMPILER_PGI_VERSION_CHECK(17, 10, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#elif COMPILER_GCC_VERSION_CHECK(3, 1, 0) || COMPILER_MSVC_VERSION_CHECK(14, 0, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_INTEL_CL_VERSION_CHECK(2021, 1, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0)       \
    || COMPILER_IBM_VERSION_CHECK(10, 1, 0) || COMPILER_PGI_VERSION_CHECK(17, 10, 0) || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0) || COMPILER_TI_CL2000_VERSION_CHECK(6, 2, 4) || COMPILER_TI_CL6X_VERSION_CHECK(8, 1, 0) \
    || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) || (COMPILER_SUNPRO_VERSION_CHECK(5, 14, 0) && defined(__cplusplus)) || COMPILER_IAR_VERSION_CHECK(8, 0, 0) || defined(__clang__) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#elif COMPILER_MSVC_VERSION_CHECK(12, 0, 0) || COMPILER_INTEL_CL_VERSION_CHECK(2021, 1, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 1, 0) || COMPILER_TI_CL430_VERSION_CHECK(3, 1, 0) \
    || COMPILER_TI_CL2000_VERSION_CHECK(6, 2, 0) || COMPILER_TI_CL6X_VERSION_CHECK(8, 0, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#endif
#if COMPILER_HAS_ATTRIBUTE(always_inline) || COMPILER_GCC_VERSION_CHECK(4, 0, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_SUNPRO_VERSION_CHECK(5, 11, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0)                    \
    || COMPILER_IBM_VERSION_CHECK(10, 1, 0) || COMPILER_TI_VERSION_CHECK(15, 12, 0) || (COMPILER_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0)          \
    || (COMPILER_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || (COMPILER_TI_CL430_VERSION_CHECK(4, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) \
    || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0) || (COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0)     \
    || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10) || COMPILER_IAR_VERSION_CHECK(8, 10, 0)
...
#define COMPILER_ALWAYS_INLINE __forceinline
    ...
    && (COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0) || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0) || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || COMPILER_TI_CL6X_VERSION_CHECK(6, 1, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0) \
        || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0))
...
#endif
#if COMPILER_HAS_ATTRIBUTE(noinline) || COMPILER_GCC_VERSION_CHECK(4, 0, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_SUNPRO_VERSION_CHECK(5, 11, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0)                         \
    || COMPILER_IBM_VERSION_CHECK(10, 1, 0) || COMPILER_TI_VERSION_CHECK(15, 12, 0) || (COMPILER_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_ARMCL_VERSION_CHECK(5, 2, 0)          \
    || (COMPILER_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL2000_VERSION_CHECK(6, 4, 0) || (COMPILER_TI_CL430_VERSION_CHECK(4, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) \
    || COMPILER_TI_CL430_VERSION_CHECK(4, 3, 0) || (COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0) || COMPILER_TI_CL7X_VERSION_CHECK(1, 2, 0)     \
    || COMPILER_TI_CLPRU_VERSION_CHECK(2, 1, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10) || COMPILER_IAR_VERSION_CHECK(8, 10, 0)
...
#else
#if COMPILER_HAS_ATTRIBUTE(visibility) || COMPILER_GCC_VERSION_CHECK(3, 3, 0) || COMPILER_SUNPRO_VERSION_CHECK(5, 11, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0) \
    || COMPILER_IBM_VERSION_CHECK(13, 1, 0) || (defined(__TI_EABI__) && ((COMPILER_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) || COMPILER_TI_CL6X_VERSION_CHECK(7, 5, 0)))  \
    || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#endif
#if COMPILER_HAS_ATTRIBUTE(nothrow) || COMPILER_GCC_VERSION_CHECK(3, 3, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
#define COMPILER_NO_THROW __attribute__((__nothrow__))
#elif COMPILER_MSVC_VERSION_CHECK(13, 1, 0) || COMPILER_INTEL_CL_VERSION_CHECK(2021, 1, 0) || COMPILER_ARM_VERSION_CHECK(4, 1, 0)
...
#endif
#if COMPILER_HAS_ATTRIBUTE(fallthrough) || COMPILER_GCC_VERSION_CHECK(7, 0, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#endif
#if COMPILER_HAS_ATTRIBUTE(returns_nonnull) || COMPILER_GCC_VERSION_CHECK(4, 9, 0) || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
// FIXME
#if defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L) && !defined(__STDC_NO_VLA__) && !defined(__cplusplus) && !defined(COMPILER_PGI_VERSION) && !defined(COMPILER_TINYC_VERSION)
...
#endif
#if COMPILER_HAS_BUILTIN(__builtin_constant_p) || COMPILER_GCC_VERSION_CHECK(3, 4, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_TINYC_VERSION_CHECK(0, 9, 19) || COMPILER_ARM_VERSION_CHECK(4, 1, 0) \
    || COMPILER_IBM_VERSION_CHECK(13, 1, 0) || COMPILER_TI_CL6X_VERSION_CHECK(6, 1, 0) || (COMPILER_SUNPRO_VERSION_CHECK(5, 10, 0) && !defined(__cplusplus)) || COMPILER_CRAY_VERSION_CHECK(8, 1, 0)             \
    || COMPILER_MCST_LCC_VERSION_CHECK(1, 25, 10)
#define COMPILER_IS_CONSTANT(expr) __builtin_constant_p(expr)
#endif
#if !defined(__cplusplus)
#if COMPILER_HAS_BUILTIN(__builtin_types_compatible_p) || COMPILER_GCC_VERSION_CHECK(3, 4, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) || COMPILER_IBM_VERSION_CHECK(13, 1, 0) || COMPILER_CRAY_VERSION_CHECK(8, 1, 0) \
    || COMPILER_ARM_VERSION_CHECK(5, 4, 0) || COMPILER_TINYC_VERSION_CHECK(0, 9, 24)
#if defined(__INTPTR_TYPE__)
#define COMPILER_IS_CONSTEXPR_(expr) __builtin_types_compatible_p(__typeof__((1 ? (void *)((__INTPTR_TYPE__)((expr)*0)) : (int *)0)), int *)
#else
#include <stdint.h>
#define COMPILER_IS_CONSTEXPR_(expr) __builtin_types_compatible_p(__typeof__((1 ? (void *)((intptr_t)((expr)*0)) : (int *)0)), int *)
#endif
#elif (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L) && !defined(COMPILER_SUNPRO_VERSION) && !defined(COMPILER_PGI_VERSION) && !defined(COMPILER_IAR_VERSION))                                      \
    || (COMPILER_HAS_EXTENSION(c_generic_selections) && !defined(COMPILER_IAR_VERSION)) || COMPILER_GCC_VERSION_CHECK(4, 9, 0) || COMPILER_INTEL_VERSION_CHECK(17, 0, 0) || COMPILER_IBM_VERSION_CHECK(12, 1, 0) \
    || COMPILER_ARM_VERSION_CHECK(5, 3, 0)
#if defined(__INTPTR_TYPE__)
#define COMPILER_IS_CONSTEXPR_(expr) _Generic((1 ? (void *)((__INTPTR_TYPE__)((expr)*0)) : (int *)0), int * : 1, void * : 0)
#else
#include <stdint.h>
#define COMPILER_IS_CONSTEXPR_(expr) _Generic((1 ? (void *)((intptr_t)*0) : (int *)0), int * : 1, void * : 0)
#endif
#elif defined(COMPILER_GCC_VERSION) || defined(COMPILER_INTEL_VERSION) || defined(COMPILER_TINYC_VERSION) || defined(COMPILER_TI_ARMCL_VERSION) || COMPILER_TI_CL430_VERSION_CHECK(18, 12, 0) || defined(COMPILER_TI_CL2000_VERSION) \
    || defined(COMPILER_TI_CL6X_VERSION) || defined(COMPILER_TI_CL7X_VERSION) || defined(COMPILER_TI_CLPRU_VERSION) || defined(__clang__)
#define COMPILER_IS_CONSTEXPR_(expr) (sizeof(void) != sizeof(*(1 ? ((void *)((expr)*0L)) : ((struct { char v[sizeof(void) * 2]; } *)1))))
#endif
#endif
...
#endif
#if !defined(__cplusplus)                                                                                                                                                                                                               \
    && ((defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L)) || (COMPILER_HAS_FEATURE(c_static_assert) && !defined(COMPILER_INTEL_CL_VERSION)) || COMPILER_GCC_VERSION_CHECK(6, 0, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0) \
        || defined(_Static_assert))
#define COMPILER_STATIC_ASSERT(expr, message) _Static_assert(expr, message)
#elif (defined(__cplusplus) && (__cplusplus >= 201103L)) || COMPILER_MSVC_VERSION_CHECK(16, 0, 0) || COMPILER_INTEL_CL_VERSION_CHECK(2021, 1, 0)
#define COMPILER_STATIC_ASSERT(expr, message) COMPILER_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_(static_assert(expr, message))
#else
...
#define COMPILER_WARNING(msg)                   \
    ...
    COMPILER_DIAGNOSTIC_POP
#elif COMPILER_GCC_VERSION_CHECK(4, 8, 0) || COMPILER_PGI_VERSION_CHECK(18, 4, 0) || COMPILER_INTEL_VERSION_CHECK(13, 0, 0)
...
#define COMPILER_REQUIRE(expr) \
    COMPILER_DIAGNOSTIC_PUSH   \
    _Pragma("clang diagnostic ignored \"-Wgcc-compat\"") __attribute__((diagnose_if(!(expr), #expr, "error"))) COMPILER_DIAGNOSTIC_POP
#define COMPILER_REQUIRE_MSG(expr, msg) \
    COMPILER_DIAGNOSTIC_PUSH            \
    _Pragma("clang diagnostic ignored \"-Wgcc-compat\"") __attribute__((diagnose_if(!(expr), msg, "error"))) COMPILER_DIAGNOSTIC_POP
#else
...
#endif
#if COMPILER_HAS_ATTRIBUTE(flag_enum) && (!defined(__cplusplus) || COMPILER_HAS_WARNING("-Wbitfield-enum-conversion"))
...
#endif
#if (COMPILER_MSVC_VERSION_CHECK(19, 0, 23918) && !COMPILER_MSVC_VERSION_CHECK(20, 0, 0)) || COMPILER_INTEL_CL_VERSION_CHECK(2021, 1, 0)
