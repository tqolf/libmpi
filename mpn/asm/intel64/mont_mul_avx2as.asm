...
;*************************************************************
;* void mont_mul4n_avx2(uint64_t* pR,
;*                 const uint64_t* pA,
;*                 const uint64_t* pB,
;*                 const uint64_t* pModulo, int mSize,
;*                       uint64_t m0,
;*                       uint64_t* pBuffer)
;*************************************************************
align ARCH_ALIGN_FACTOR
IPPASM mont_mul4n_avx2,PUBLIC
...
.norm_loop:
   ...
   REST_GPR
   ret
ENDFUNC mont_mul4n_avx2


;*************************************************************
;* void mont_mul4n1_avx2(uint64_t* pR,
;*                  const uint64_t* pA,
;*                  const uint64_t* pB,
;*                  const uint64_t* pModulo, int mSize,
;*                        uint64_t m0,
...
;*************************************************************
align ARCH_ALIGN_FACTOR
IPPASM mont_mul4n1_avx2,PUBLIC
%assign LOCAL_FRAME sizeof(qword)*5
        USES_GPR rsi,rdi,rbx,rbp,r12,r13,r14
        USES_XMM_AVX ymm6,ymm7,ymm8,ymm9,ymm10,ymm11,ymm12,ymm13
        COMP_ABI 7
...
.norm_loop:
   ...
   REST_GPR
   ret
ENDFUNC mont_mul4n1_avx2


;*************************************************************
;* void mont_mul4n2_avx2(uint64_t* pR,
;*                  const uint64_t* pA,
;*                  const uint64_t* pB,
;*                  const uint64_t* pModulo, int mSize,
;*                        uint64_t m0,
...
;*************************************************************
align ARCH_ALIGN_FACTOR
IPPASM mont_mul4n2_avx2,PUBLIC
%assign LOCAL_FRAME sizeof(qword)*5
        USES_GPR rsi,rdi,rbx,rbp,r12,r13,r14
        USES_XMM_AVX ymm6,ymm7,ymm8,ymm9,ymm10,ymm11,ymm12,ymm13
        COMP_ABI 7
...
.norm_loop:
   ...
   REST_GPR
   ret
ENDFUNC mont_mul4n2_avx2


;*************************************************************
;* void mont_mul4n3_avx2(uint64_t* pR,
;*                  const uint64_t* pA,
;*                  const uint64_t* pB,
;*                  const uint64_t* pModulo, int mSize,
;*                        uint64_t m0,
...
;*************************************************************
align ARCH_ALIGN_FACTOR
IPPASM mont_mul4n3_avx2,PUBLIC
%assign LOCAL_FRAME sizeof(qword)*5
        USES_GPR rsi,rdi,rbx,rbp,r12,r13,r14
        USES_XMM_AVX ymm6,ymm7,ymm8,ymm9,ymm10,ymm11,ymm12,ymm13
        COMP_ABI 7
