...
;*************************************************************
;* void sqr_avx2(uint64_t* pR,
;*           const uint64_t* pA, int aSize,
;*                 uint64_t* pBuffer)
;*************************************************************
align ARCH_ALIGN_FACTOR
IPPASM sqr_avx2_V0,PUBLIC
...
;*************************************************************
;* void mont_red_avx2(uint64_t* pR,
;*                     uint64_t* pProduct,
;*               const uint64_t* pModulus, int mSize,
;*                     uint64_t* k0)
;*************************************************************
align ARCH_ALIGN_FACTOR
IPPASM mont_red_avx2,PUBLIC
